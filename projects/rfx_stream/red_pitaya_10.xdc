...
set_property PACKAGE_PIN W14 [get_ports {adc_dat_a[0]}]
set_property PACKAGE_PIN Y14 [get_ports {adc_dat_a[1]}]
set_property PACKAGE_PIN W13 [get_ports {adc_dat_a[2]}]
set_property PACKAGE_PIN V12 [get_ports {adc_dat_a[3]}]
set_property PACKAGE_PIN V13 [get_ports {adc_dat_a[4]}]
set_property PACKAGE_PIN T14 [get_ports {adc_dat_a[5]}]
set_property PACKAGE_PIN T15 [get_ports {adc_dat_a[6]}]
set_property PACKAGE_PIN V15 [get_ports {adc_dat_a[7]}]
set_property PACKAGE_PIN T16 [get_ports {adc_dat_a[8]}]
set_property PACKAGE_PIN V16 [get_ports {adc_dat_a[9]}]
...
set_property PACKAGE_PIN R19 [get_ports {adc_dat_b[0]}]
set_property PACKAGE_PIN T20 [get_ports {adc_dat_b[1]}]
set_property PACKAGE_PIN T19 [get_ports {adc_dat_b[2]}]
set_property PACKAGE_PIN U20 [get_ports {adc_dat_b[3]}]
set_property PACKAGE_PIN V20 [get_ports {adc_dat_b[4]}]
set_property PACKAGE_PIN W20 [get_ports {adc_dat_b[5]}]
set_property PACKAGE_PIN W19 [get_ports {adc_dat_b[6]}]
set_property PACKAGE_PIN Y19 [get_ports {adc_dat_b[7]}]
set_property PACKAGE_PIN W18 [get_ports {adc_dat_b[8]}]
set_property PACKAGE_PIN Y18 [get_ports {adc_dat_b[9]}]
