...
#
# This file has been derived from 14-bit redpitaya but with clock and trigger filepped
# Due to an error in the design of the directional coupler board in SPIDER
# 
...
set_property PACKAGE_PIN K17 [get_ports trigger_in_0]
...
set_property PACKAGE_PIN H16 [get_ports ext_clk]
