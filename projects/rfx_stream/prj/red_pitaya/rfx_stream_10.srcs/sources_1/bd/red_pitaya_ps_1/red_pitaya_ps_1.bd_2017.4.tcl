...
proc create_root_design { parentCell } {
  ...
  set adc_clk_i [ create_bd_port -dir I adc_clk_i ]
  set adc_dat_a [ create_bd_port -dir I -from 13 -to 4 adc_dat_a ]
  set adc_dat_b [ create_bd_port -dir I -from 13 -to 4 adc_dat_b ]
  ...
  connect_bd_net -net util_ds_buf_0_IBUF_OUT [get_bd_ports adc_clk_i] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_red_pitaya_adc_0/aclk]
