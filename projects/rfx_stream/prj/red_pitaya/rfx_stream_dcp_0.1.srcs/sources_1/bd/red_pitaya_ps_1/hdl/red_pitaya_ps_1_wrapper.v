...
module red_pitaya_ps_1_wrapper
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  input [0:0]adc_clk_i_clk_n;
  input [0:0]adc_clk_i_clk_p;
  ...
  wire Led;
  wire [0:0]adc_cdcs_o;
  wire [0:0]adc_clk_i_clk_n;
  wire [0:0]adc_clk_i_clk_p;
  wire [13:0]adc_dat_a;
  wire [13:0]adc_dat_b;
  wire ext_clk;
  wire led_o;
  ...
  red_pitaya_ps_1 red_pitaya_ps_1_i
       (.DDR_addr(DDR_addr),
        ...
        .adc_clk_i_clk_n(adc_clk_i_clk_n),
        .adc_clk_i_clk_p(adc_clk_i_clk_p),
        .adc_dat_a(adc_dat_a),
        .adc_dat_b(adc_dat_b),
        .ext_clk(ext_clk),
        .led_o(led_o),
