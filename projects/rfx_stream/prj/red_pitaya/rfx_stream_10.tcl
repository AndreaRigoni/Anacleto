...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 create_project rfx_stream_10  "$make_env(builddir)/edit/red_pitaya"  -part xc7z010clg400-1
...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 file mkdir "$project_env(dir_prj)/rfx_stream_10.srcs/sources_1/bd/red_pitaya_ps_1"
 file copy -force "$project_env(dir_src)/rfx_stream_10.srcs/sources_1/bd/red_pitaya_ps_1/red_pitaya_ps_1.bd" \
    "$project_env(dir_prj)/rfx_stream_10.srcs/sources_1/bd/red_pitaya_ps_1/red_pitaya_ps_1.bd"
 file mkdir "$project_env(dir_prj)/rfx_stream_10.srcs/sources_1/bd/red_pitaya_ps_1/hdl"
 file copy -force "$project_env(dir_src)/rfx_stream_10.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.v" \
    "$project_env(dir_prj)/rfx_stream_10.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.v"
 set files [list \
  "[file normalize $project_env(dir_src)/rfx_stream_10.srcs/sources_1/imports/src/timing_highway.vhdl]"\
  "[file normalize $project_env(dir_src)/rfx_stream_10.srcs/sources_1/imports/src/resampler.vhdl]"\
  "[file normalize $project_env(dir_src)/rfx_stream_10.srcs/sources_1/imports/src/trarec.vhdl]"\
  "[file normalize $project_env(dir_src)/rfx_stream_10.srcs/sources_1/imports/src/trarec_tb.vhdl]"\
 ]
 set imported_files [import_files -fileset sources_1 $files]
 set files [list \
  "[file normalize $make_env(srcdir)/src/trarec.vhdl]"\
  "[file normalize $project_env(dir_prj)/rfx_stream_10.srcs/sources_1/bd/red_pitaya_ps_1/red_pitaya_ps_1.bd]"\
  "[file normalize $project_env(dir_prj)/rfx_stream_10.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.v]"\
 ...
 # Properties for resampler.vhdl
  ...
  set_property -quiet "used_in_synthesis" "1" $file_obj
 # 
 # Properties for timing_highway.vhdl
  set file "$project_env(dir_src)/../../src/timing_highway.vhdl"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
 ...
 # 
 # Properties for timing_highway.vhdl
  set file "$project_env(dir_prj)/rfx_stream_10.srcs/sources_1/imports/src/timing_highway.vhdl"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
  set_property -quiet "is_global_include" "0" $file_obj
 ...
 # 
 # Properties for resampler.vhdl
  set file "$project_env(dir_prj)/rfx_stream_10.srcs/sources_1/imports/src/resampler.vhdl"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
  set_property -quiet "is_global_include" "0" $file_obj
 ...
 # Properties for red_pitaya_ps_1.bd
  set file "$project_env(dir_prj)/rfx_stream_10.srcs/sources_1/bd/red_pitaya_ps_1/red_pitaya_ps_1.bd"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
 ...
 # Properties for red_pitaya_ps_1_wrapper.v
  set file "$project_env(dir_prj)/rfx_stream_10.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.v"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
 ...
 # 
 # Properties for trarec.vhdl
  set file "$project_env(dir_prj)/rfx_stream_10.srcs/sources_1/imports/src/trarec.vhdl"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
  set_property -quiet "is_global_include" "0" $file_obj
 ...
 # 
 # Properties for trarec_tb.vhdl
  set file "$project_env(dir_prj)/rfx_stream_10.srcs/sources_1/imports/src/trarec_tb.vhdl"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
  set_property -quiet "is_global_include" "0" $file_obj
 ...
 set files [list \
  "[file normalize $project_env(dir_src)/rfx_stream_10.srcs/constrs_1/imports/rfx_stream/red_pitaya_10.xdc]"\
 ]
 set imported_files [import_files -fileset constrs_1 $files]
 set files [list \
  "[file normalize $make_env(srcdir)/./red_pitaya_10.xdc]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # Properties for red_pitaya_10.xdc
  set file "$project_env(dir_src)/../../red_pitaya_10.xdc"
  set file [file normalize $file]
 ...
 # 
 # Properties for red_pitaya_10.xdc
  set file "$project_env(dir_prj)/rfx_stream_10.srcs/constrs_1/imports/rfx_stream/red_pitaya_10.xdc"
  set file_obj [get_files -of_objects [get_filesets constrs_1] [list "$file"]]
  set_property -quiet "file_type" "XDC" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
  set_property -quiet "is_global_include" "0" $file_obj
