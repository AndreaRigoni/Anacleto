...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 create_project rfx_stream_dcp_0.1  "$make_env(builddir)/edit/red_pitaya"  -part xc7z010clg400-1
...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 file mkdir "$project_env(dir_prj)/rfx_stream_dcp_0.1.srcs/sources_1/bd/red_pitaya_ps_1"
 file copy -force "$project_env(dir_src)/rfx_stream_dcp_0.1.srcs/sources_1/bd/red_pitaya_ps_1/red_pitaya_ps_1.bd" \
    "$project_env(dir_prj)/rfx_stream_dcp_0.1.srcs/sources_1/bd/red_pitaya_ps_1/red_pitaya_ps_1.bd"
 file mkdir "$project_env(dir_prj)/rfx_stream_dcp_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl"
 file copy -force "$project_env(dir_src)/rfx_stream_dcp_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.v" \
    "$project_env(dir_prj)/rfx_stream_dcp_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.v"
 set files [list \
  ...
  "[file normalize $project_env(dir_prj)/rfx_stream_dcp_0.1.srcs/sources_1/bd/red_pitaya_ps_1/red_pitaya_ps_1.bd]"\
  "[file normalize $project_env(dir_prj)/rfx_stream_dcp_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.v]"\
 ...
 # Properties for red_pitaya_ps_1.bd
  set file "$project_env(dir_prj)/rfx_stream_dcp_0.1.srcs/sources_1/bd/red_pitaya_ps_1/red_pitaya_ps_1.bd"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
 ...
 # Properties for red_pitaya_ps_1_wrapper.v
  set file "$project_env(dir_prj)/rfx_stream_dcp_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.v"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
 ...
 set files [list \
  "[file normalize $make_env(srcdir)/./red_pitaya_dcouplers.xdc]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # Properties for red_pitaya_dcouplers.xdc
  set file "$project_env(dir_src)/../../red_pitaya_dcouplers.xdc"
  set file [file normalize $file]
