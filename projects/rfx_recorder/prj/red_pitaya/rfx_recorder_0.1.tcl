...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 create_project rfx_recorder_0.1  "$make_env(builddir)/edit/red_pitaya"  -part xc7z010clg400-1
...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 file mkdir "$project_env(dir_prj)/rfx_recorder_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl"
 file copy -force "$project_env(dir_src)/rfx_recorder_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.vhd" \
    "$project_env(dir_prj)/rfx_recorder_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.vhd"
 set files [list \
 ...
 # 
 # Properties for timing_highway.vhdl
  set file "$project_env(dir_prj)/rfx_recorder_0.1.srcs/sources_1/imports/src/timing_highway.vhdl"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
  set_property -quiet "is_global_include" "0" $file_obj
 ...
 # 
 # Properties for resampler.vhdl
  set file "$project_env(dir_prj)/rfx_recorder_0.1.srcs/sources_1/imports/src/resampler.vhdl"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
  set_property -quiet "is_global_include" "0" $file_obj
 ...
 # Properties for red_pitaya_ps_1.bd
  set file "$project_env(dir_prj)/rfx_recorder_0.1.srcs/sources_1/bd/red_pitaya_ps_1/red_pitaya_ps_1.bd"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
 ...
 # 
 # Properties for trarec.vhdl
  set file "$project_env(dir_prj)/rfx_recorder_0.1.srcs/sources_1/imports/src/trarec.vhdl"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
  set_property -quiet "is_global_include" "0" $file_obj
 ...
 # 
 # Properties for trarec_tb.vhdl
  set file "$project_env(dir_prj)/rfx_recorder_0.1.srcs/sources_1/imports/src/trarec_tb.vhdl"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
  set_property -quiet "is_global_include" "0" $file_obj
 ...
 set files [list \
  "[file normalize $project_env(dir_src)/rfx_recorder_0.1.srcs/constrs_1/imports/rfx_recorder/red_pitaya.xdc]"\
 ]
 ...
 # 
 # Properties for red_pitaya.xdc
  set file "$project_env(dir_prj)/rfx_recorder_0.1.srcs/constrs_1/imports/rfx_recorder/red_pitaya.xdc"
  set file_obj [get_files -of_objects [get_filesets constrs_1] [list "$file"]]
  set_property -quiet "file_type" "XDC" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
  set_property -quiet "is_global_include" "0" $file_obj
