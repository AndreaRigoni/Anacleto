...
#define RFX_RECORDER_GET_COMMAND_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 20)
#define RFX_RECORDER_SET_COMMAND_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 21)
#define RFX_RECORDER_GET_DECIMATOR_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 22)
#define RFX_RECORDER_SET_DECIMATOR_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 23)
#define RFX_RECORDER_GET_DMA_SIZE_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 24)
#define RFX_RECORDER_SET_DMA_SIZE_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 25)
#define RFX_RECORDER_GET_EVENT_CODE_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 26)
#define RFX_RECORDER_SET_EVENT_CODE_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 27)
#define RFX_RECORDER_GET_MODE_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 28)
#define RFX_RECORDER_SET_MODE_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 29)
#define RFX_RECORDER_GET_PTS_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 30)
#define RFX_RECORDER_SET_PTS_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 31)
#define RFX_RECORDER_GET_STREAM_DECIMATOR_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 32)
#define RFX_RECORDER_SET_STREAM_DECIMATOR_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 33)
#define RFX_RECORDER_GET_COUNTER_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 34)
#define RFX_RECORDER_SET_COUNTER_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 35)
#define RFX_RECORDER_GET_STATUS_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 36)
#define RFX_RECORDER_SET_STATUS_REGISTER		_IO(RFX_RECORDER_IOCTL_BASE, 37)
#define RFX_RECORDER_GET_STREAM_FIFO_LEN		_IO(RFX_RECORDER_IOCTL_BASE, 38)
#define RFX_RECORDER_GET_STREAM_FIFO_VAL		_IO(RFX_RECORDER_IOCTL_BASE, 39)
#define RFX_RECORDER_CLEAR_STREAM_FIFO		_IO(RFX_RECORDER_IOCTL_BASE, 40)
