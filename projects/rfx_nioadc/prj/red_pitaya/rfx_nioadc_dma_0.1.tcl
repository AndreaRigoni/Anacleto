...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 create_project rfx_nioadc_dma_0.1  "$make_env(builddir)/edit/red_pitaya"  -part xc7z010clg400-1
...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 file mkdir "$project_env(dir_prj)/rfx_nioadc_dma_0.1.srcs/sources_1/bd/red_pitaya_ps_1"
 file copy -force "$project_env(dir_src)/rfx_nioadc_dma_0.1.srcs/sources_1/bd/red_pitaya_ps_1/red_pitaya_ps_1.bd" \
    "$project_env(dir_prj)/rfx_nioadc_dma_0.1.srcs/sources_1/bd/red_pitaya_ps_1/red_pitaya_ps_1.bd"
 file mkdir "$project_env(dir_prj)/rfx_nioadc_dma_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl"
 file copy -force "$project_env(dir_src)/rfx_nioadc_dma_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.vhd" \
    "$project_env(dir_prj)/rfx_nioadc_dma_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.vhd"
 set files [list \
  ...
  "[file normalize $make_env(srcdir)/src/trarec_dma_tb.vhdl]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # Properties for trarec_dma.vhdl
  set file "$project_env(dir_src)/../../src/trarec_dma.vhdl"
 ...
 # Properties for resampler.vhdl
  ...
  set_property -quiet "used_in_synthesis" "1" $file_obj
 # 
 # Properties for frequency_counter.v
  set file "$project_env(dir_src)/../../src/frequency_counter.v"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  ...
  set_property -quiet "used_in_synthesis" "1" $file_obj
 # 
 # Properties for vi_rms.v
  set file "$project_env(dir_src)/../../src/vi_rms.v"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "Verilog" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
  ...
  set_property -quiet "used_in_synthesis" "1" $file_obj
 # 
 # Properties for resampler_tb.vhdl
  set file "$project_env(dir_src)/../../src/resampler_tb.vhdl"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
  ...
  set_property -quiet "used_in_synthesis" "1" $file_obj
 # 
 # Properties for trarec_dma_tb.vhdl
  set file "$project_env(dir_src)/../../src/trarec_dma_tb.vhdl"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
 ...
 # Properties for red_pitaya_ps_1.bd
  set file "$project_env(dir_prj)/rfx_nioadc_dma_0.1.srcs/sources_1/bd/red_pitaya_ps_1/red_pitaya_ps_1.bd"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
 ...
 # Properties for red_pitaya_ps_1_wrapper.vhd
  set file "$project_env(dir_prj)/rfx_nioadc_dma_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.vhd"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
  set_property -quiet "is_global_include" "0" $file_obj
