...
#define DEVICE_NAME "rpadc_dma"  /* Dev name as it appears in /proc/devices */
#define MODULE_NAME "rpadc_dma"
...
#define RFX_RPADC_GET_CONFIG  			_IO(RFX_RPADC_IOCTL_BASE, 5)
#define RFX_RPADC_SET_CONFIG  			_IO(RFX_RPADC_IOCTL_BASE, 6)
#define RFX_RPADC_ARM  				_IO(RFX_RPADC_IOCTL_BASE, 7)
#define RFX_RPADC_TRIGGER  			_IO(RFX_RPADC_IOCTL_BASE, 8)
#define RFX_RPADC_STOP  			_IO(RFX_RPADC_IOCTL_BASE, 9)
#define RFX_RPADC_LAST_TIME  			_IO(RFX_RPADC_IOCTL_BASE, 10)
#define RFX_RPADC_SET_BUFSIZE  			_IO(RFX_RPADC_IOCTL_BASE, 11)
#define RFX_RPADC_GET_BUFSIZE  			_IO(RFX_RPADC_IOCTL_BASE, 12)
